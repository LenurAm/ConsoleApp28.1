...
namespace ConsoleApp28
{
    ...
    class MyEvent
    {
        public delegate void A_CreateFileA();
...

        {
            ...
            FileStream File1 = new FileStream("a.doc", FileMode.OpenOrCreate);
        ...
        public static void CorrectFileA()
        {
            string line;
            char[] separator = { ' ', '!' };
            List<string> words;
        ...
        class Program
        {
            static void Main()
            {
                ...
                Console.WriteLine($"The document is created: File2");
